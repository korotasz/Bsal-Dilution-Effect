...
m1a_plot <- ggplot(m1a_predict, aes(x , exp(predicted))) +
  ...
  ak_theme +
  labs(tag = "A",
       caption = c("Relative species abundance at a given site by species. Error bars represent 95% confidence intervals."))
...
m1b_plot <- ggplot(m1b_predict, aes(x , predicted)) +
  ...
  ak_theme +
  labs(tag = "B",
       caption = c("Proportion of disease prevalence (including both Bsal and Bd) by species."))
