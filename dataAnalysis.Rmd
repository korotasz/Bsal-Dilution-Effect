...
2. Cbind models for all salamander spp.
   a. T0 (At time of observation); T-1 (30 days prior to initial obs.); T-2 (60 days prior to initial obs.)
```{r}
...
```
   ...
   b. Prevalence by Abundance & Richness Plots for T0, T-1, T-2 
```{r}
# T0
...
```
   ...
   c. Prevalence by Temperature & Soil Moisture Plots for T0, T-1, T-2
```{r}
# T0
...
```
   ...
   b. Prevalence by Abundance & Richness Plots for T0, T-1, T-2 (Fire Salamanders Only)
```{r}
# T0
...
```
   ...
   c. Prevalence by Temperature & Soil Moisture Plots for T0, T-1, T-2 (Fire Salamanders Only)
```{r}
# T0
...
```
   ...
   b. Interaction plot for fire salamanders only
```{r}
# T0
