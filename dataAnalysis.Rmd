...
m2_p1 <- annotate_figure(m2_p1_combined, bottom = textGrob("Timepoints above each graph indicate the time from the initial observation.", x = 0, 
...
m2_p2 <- annotate_figure(m2_p2_combined, bottom = textGrob(bquote("Soil moisture ranged from 5.33-5.37 (kg/m"^2~"), 6.11-6.13 (kg/m"^2~"), and 6.85-6.97 (kg/m"^2~"), for the Low, Medium, and High categories respectively. Timepoints above each graph indicate the time from the initial observation."), x = 0, 
                                                  hjust = 0, gp = gpar(fontsize = 12)))
