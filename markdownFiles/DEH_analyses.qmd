...
format: 
  html:
    ...
    code-links:
      ...
      - text: Google Drive
        icon: google
        href: https://drive.google.com/drive/u/0/folders/0AJIVquSfTYvKUk9PVA
    other-links: 
      - text: NASA GLDAS
        icon: database-down
        href: https://tinyurl.com/yc3ubfn3
      - text: WorldClim (v2.1)
        icon: database-down
        href: https://www.worldclim.org/data/index.html#
    toc: true
    toc-location: left
    toc_depth: 6
    freeze: auto
...
posSites_reduced <- posSites %>% 
  ...
  mutate(year = as.numeric(year),
         ...
         day = as.numeric(day)) %>% 
  subset(., select = c(Site, richness, iucn_rich, locality_rich, logsppAbun, logsiteAbun, nPos_all, nNeg_all, temp_d, sMoist_d, bio1_wc, bio12_wc))
